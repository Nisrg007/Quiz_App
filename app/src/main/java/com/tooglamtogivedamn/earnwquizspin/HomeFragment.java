...
import com.tooglamtogivedamn.earnwquizspin.databinding.FragmentHomeBinding;
...
binding.shareText.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "Hey, Checkout this amazing app:" + playStoreLink);
